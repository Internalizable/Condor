            ...
            <div class="row"> 
              ...
              while($row=mysqli_fetch_array($image_query))
              {
                ...
                if(!file_exists("../img/back/product/".$image_path))
                {
                  ...
                  echo"<div class='col-6 col-md-4 col-lg-3'>";
                  echo"<div class='card mb-4'><a class='glightbox' href='../img/back/product/". $image_path."'"." data-gallery='gallery' data-title='Image 1'>";
                  echo"<img style='height:200px;' class='card-img-top' src='../img/back/product/". $image_path."' alt='Image 1'></a>";
                    echo" <div class='card-body p-3 p-lg-4'>";
