...
//$prodID=$_GET[id];
$result=mysqli_query($con,"select * from products where id=".base64_decode($_GET["id"]));
$product = mysqli_fetch_array($result);
$tags_result=mysqli_query($con,"select * from products_tags where products_id=".base64_decode($_GET["id"]));
$category_result=mysqli_query($con,"select * from products_categories where products_id=".base64_decode($_GET["id"]));
