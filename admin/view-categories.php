...
*/
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="componentsDropdown">
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="components-cards.html">Cards</a></li>
        ...
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Categories</h1>
                  <?php 
                  $query=mysqli_query($conn,"select count(*) as tot from categories");
    ...
    while ($row = mysqli_fetch_array($result)){
               ...
               echo"<h6 class='card-title'>". " Sub Category Name: "."<br>" . $category_name ."</h6>". 
                "<p class='card-text'></p>";
     ...
     echo"</div>";
       echo "</div></div>";
     			  ...
     			  //echo "<p style='text-align:center;color:red;font-weight:bold;font-size:20px;'>$category_name </p>";
