...
<html>
  ...
  <body>
        ...
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Categories</h1>
                  <?php 
                  $query=mysqli_query($conn,"select count(*) as tot from categories where isDeleted=0");
                  
                  while($row3 = mysqli_fetch_array($query)){
                      
                      echo"<h6>"."Total Categories: " . $row3['tot'] . "</h6>";
    ...
    while ($row = mysqli_fetch_array($result)){
                ...
                echo" <a class='btn btn-primary' href='update-category.php?id="./*base64_encode(*/$row["id"]/*)*/."'>Edit</a>"." ". "<a class='btn btn-primary archiver' href='delete-category-inter.php?id=" . base64_encode($row["id"]) . "'  >Archive</a> <br> <br> <br>";
                $result2=mysqli_query($conn,"select * from categories where parent_id='$parent_category_id' and isDeleted=0;");
                while ($row2 = mysqli_fetch_array($result2)){
                $category_name = $row2['name']; 
               echo"<h6 class='card-title'>". " Sub Category Name: "."<br>" . $category_name ."</h6>"."<p class='card-text'></p>";
                 echo" <a class='btn btn-info' href='update-category.php?id="./*base64_encode(*/$row2['id']/*)*/."'>Edit</a>"." ". "<a class='btn btn-info archiver' 
