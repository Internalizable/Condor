...
echo "<p class="card-text">". "Description:" .$product_desc. "</p>";
echo "<p class="card-text">". "Quantity:" . $product_quantity. "</p>";
...
*/
    ...
    <!-- navbar-->
    <header class="header">
      <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow"><a class="navbar-brand fw-bold text-uppercase text-base" href="../index.html"><span class="d-none d-brand-partial">Condor </span></a>
    ...
    <div class="sidebar py-3" id="sidebar">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#e-commerceDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse">
                ...
                <li class="sidebar-list-item"><a class="sidebar-link text-muted" href="view-categories.php">New Category</a></li>
  ...
  echo"   <div class='col-md-6 col-lg-3'> <div class='card mb-4'>";
                ...
                else
                {
                  $image_path="default.jpg";
                   ...
                   echo "<img class='card-img-top img-fluid' style='height:250px;' src='../img/back/product/".$image_path."'"." alt='Card image cap'>";
               ...
               "<p class='card-text'>" . "Price:" . $product_price ."</p>". "<a class='btn btn-primary' href='update-product.php?id=".base64_encode($product_id)."'>Edit</a>"." ".
                "<a class='btn btn-primary' onclick='confirmDelete()'
                 href='delete-product-inter.php?id=".base64_encode($product_id)."'>Archive</a>"." "."<a class='btn btn-primary' 
